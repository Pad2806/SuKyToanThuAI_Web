...
import { CreatorLoadingScreen } from '../components/ai-studio/creator-loading-screen.jsx';
...
export const CreatorPage = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    setPending(null);
    try {
      const response = await createCreatorPage({ content });
  ...
  return (
    <section className="creator-page">
      ...
      {status === 'loading' && <CreatorLoadingScreen content={content} />}
